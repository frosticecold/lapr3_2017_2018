...
public class GraphTest {
    ...
    public void testNumVertices() {
        ...
        assertFalse("cant insert same vertex", instance.insertVertex("A"));
    ...
    public void testVertices() {
        ...
        assertFalse("cant remove inexistant vertex", instance.removeVertex("A"));
    ...
    public void testNumEdges() {
        ...
        assertFalse("edge already exists", instance.insertEdge("A", "B", "Edge1", 6));
        ...
        assertFalse("cant remove edge of invalid vertexes", instance.removeEdge("K", "P"));

        assertFalse("cant remove inexistante edge", instance.removeEdge("A", "B"));
    ...
    public void testEndVertices() {
        ...
        assertTrue("invalid vertex", instance.endVertices(new Edge<>()) == null);
        assertNull("null vertex", instance.endVertices(null));
    }
    ...
    public void testOpposite() {
        ...
        assertTrue("invalid vertex", instance.opposite("K", edge5) == null);
    ...
    public void testOutgoingEdges() {
        ...
        assertTrue("invalid vertex", instance.outgoingEdges("K") == null);
    ...
    public void testIncomingEdges() {
        ...
        assertTrue("invalid vertex", instance.incomingEdges("K") == null);
    ...
    public void testToString() {
        ...
        instance.insertEdge("A", "B", "Edge1", 6);
        expResult = "Graph: 2 vertices, 1 edges\n"
                + "A (0): \n"
                + "      (Edge1) - 6.0 - B\n"
                + "\n"
                + "B (1): \n"
