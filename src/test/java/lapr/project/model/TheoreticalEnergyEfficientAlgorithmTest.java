...
public class TheoreticalEnergyEfficientAlgorithmTest {
   Project project;
     ...
     */
    @Test
    public void testTheoreticalEnergyEfficientPath() {
        ...
        AlgorithmResults result = alg.bestPath(graph, vOrig, vDest, vh1, 1);
        ...
        assertEquals(result.getEnergy(), (2.98 * Math.pow(10, 8)), (0.1 * Math.pow(10, 8)));
        assertEquals(result.getAlgorithmType(), "Theoretical Most Energy Efficient Path");
    }

    @Test
    public void test2TheoreticalEnergyEfficientPath() {
        System.out.println("TheoreticalEnergyEfficientPath");
        Graph<Junction, Section> graph = project.getRoadNetwork();
        Junction vOrig = project.getJunction("n0");
        ...
        assertEquals(result.getCost(), 0, 0.5);
        assertEquals(result.getEnergy(), (4.62 * Math.pow(10, 8)), (0.1 * Math.pow(10, 8)));
        assertEquals(result.getAlgorithmType(), "Theoretical Most Energy Efficient Path");
    }
}
