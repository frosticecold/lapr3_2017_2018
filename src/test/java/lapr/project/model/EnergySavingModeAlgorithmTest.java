 ...
 * @author MarioDias
 */
public class EnergySavingModeAlgorithmTest {

    public EnergySavingModeAlgorithmTest() {
    }
    Project project;
    ...
    /**
     * Test of bestPath method, of class EnergySavingModeAlgorithm.
     */
    @Test
    public void testBestPath() {
        ...
        EnergySavingModeAlgorithm instance = new EnergySavingModeAlgorithm();
        AlgorithmResults result = instance.bestPath(project.getRoadNetwork(), start, end, v, acceleration);
        assertTrue(result.getVehicle().equals(vh1));
        assertTrue(result.getJunctionPath().contains(start));
        assertTrue(result.getJunctionPath().contains(end));
    ...
    /**
     * Test of toString method, of class EnergySavingModeAlgorithm.
     */
    @Test
    public void testToString() {
        System.out.println("toString");
        EnergySavingModeAlgorithm instance = new EnergySavingModeAlgorithm();
        String expResult = "Energy Saving Mode Algorithm";
