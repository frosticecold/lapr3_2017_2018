 ...
 * @author pc asus
 */
public class ListOfResultsTest {

    Project project;
    Graph<Junction, Section> roadNetwork;
    Vehicle vh1;

    public ListOfResultsTest() {
    }
    ...
    /**
     * Test of addResult method, of class ListOfResults.
     */
    @Test
    public void testAddResult() {
        System.out.println("addResult");
        PathAlgorithm alg = new FastestPathAlgorithm();
        AlgorithmResults result1 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n0"), project.getJunction("n3"), vh1, 0);
        AlgorithmResults result2 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n2"), project.getJunction("n4"), vh1, 0);
        ListOfResults instance = new ListOfResults();
        assertTrue(instance.addResult(vh1, result1));
        assertTrue(instance.addResult(vh1, result2));
        assertFalse(instance.addResult(vh1, result1));
        assertFalse(instance.addResult(vh1, result2));

    }

    /**
     * Test of getMapOfResults method, of class ListOfResults.
     */
    @Test
    public void testGetMapOfResults() {
        System.out.println("getMapOfResults");
        ListOfResults instance = new ListOfResults();
        PathAlgorithm alg = new FastestPathAlgorithm();
        AlgorithmResults result1 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n0"), project.getJunction("n3"), vh1, 0);
        AlgorithmResults result2 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n2"), project.getJunction("n4"), vh1, 0);
        instance.addResult(vh1, result1);
        instance.addResult(vh1, result2);
        Map<Vehicle, List<AlgorithmResults>> result = instance.getMapOfResults();
        assertTrue(!result.isEmpty());
        assertTrue(result.containsKey(vh1));
    }

    /**
     * Test of vehicleIterator method, of class ListOfResults.
     */
    @Test
    public void testVehicleIterator() {
        System.out.println("vehicleIterator");
        ListOfResults instance = new ListOfResults();
        PathAlgorithm alg = new FastestPathAlgorithm();
        AlgorithmResults result1 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n0"), project.getJunction("n3"), vh1, 0);
        AlgorithmResults result2 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n2"), project.getJunction("n4"), vh1, 0);
        instance.addResult(vh1, result1);
        instance.addResult(vh1, result2);
        Iterator<Vehicle> result = instance.vehicleIterator();
        while(result.hasNext()) {
            Vehicle v = result.next();
            assertEquals(vh1, v);
        }
        instance.clearList();
    }
    ...
    /**
     * Test of getListOfResults method, of class ListOfResults.
     */
    @Test
    public void testGetListOfResults() {
        System.out.println("getListOfResults");
        ListOfResults instance = new ListOfResults();
        PathAlgorithm alg = new FastestPathAlgorithm();
        AlgorithmResults result1 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n0"), project.getJunction("n3"), vh1, 0);
        AlgorithmResults result2 = alg.bestPath(project.getRoadNetwork(), project.getJunction("n2"), project.getJunction("n4"), vh1, 0);
        Iterable<AlgorithmResults> result = instance.getListOfResults(vh1);
        assertFalse(result.iterator().hasNext());
        instance.addResult(vh1, result1);
        instance.addResult(vh1, result2);
        result = instance.getListOfResults(vh1);
